...
from src.addonpy import AddonLoader as loader
...
loader_mgr = loader(verbose=True, logger=LogModule(), recursive=True, lazy_load=True)
...
print(loader_mgr.get_loaded_addons(['2']))
